...
**▶ Play it live:** https://buicongnguyen.github.io/pixel-life-journey-v2/
...
- **🟢🔴 Touch the good, use the tray, dodge the bad** — it plays like an arcade game. Common good things drift
  **away**; catch them by touching them, and they respawn somewhere else. Collected
  items also stack in the bottom tray: swipe left/right to pick one and swipe up near
  a person to use it as a social reaction. Bad things (junk food, all-night gaming)
  chase **you** and apply on contact. Do the **matching good thing** and the bad one **freezes
